...
#define	MPU9250_ADDRESS_GYRO_ACCEL   0x68	  //陀螺加速度地址
#define MPU9250_ADDRESS_MAG          0x0C     //磁场地址
...
extern void mpu9250_get_gyro_acc(uint16_t *dst_gyro, uint16_t *dst_acc);
extern void mpu9250_get_gyro_acc_mag(uint16_t *dst_gyro, uint16_t *dst_acc, uint16_t *dst_mag);
extern void mpu9250_get_acc(uint16_t *dst);
extern void mpu9250_get_gyro(uint16_t *dst);
extern void mpu9250_get_magn(uint16_t *dst);
extern void mpu9250_get_magn_adjust(uint8_t *dst);

//下面两个函数用于I2C模式，见mpu9250_i2c.c
extern void mpu9250_acc_gyro_set_addr(void);
extern void mpu9250_magn_set_addr(void);

//test
extern uint8_t mpu9250_get_mag_wia(void);
